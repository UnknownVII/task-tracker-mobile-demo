...
class flutterSwitch extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FlutterSwitch(
        ...
        inactiveSwitchBorder: Border.all(color: Color(0xFFE4EBF8), width: 2, strokeAlign: BorderSide.strokeAlignOutside),
        activeColor: Colors.transparent,
        activeSwitchBorder: Border.all(color: Color(0xFF21E6C1), width: 2, strokeAlign: BorderSide.strokeAlignOutside),
